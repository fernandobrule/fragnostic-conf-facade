...
object Dependencies {
  ...
  lazy val fragnosticConfCache        = "com.fragnostic"        % "fragnostic-conf-cache_2.13"          % "0.2.7"
  lazy val fragnosticConfProps        = "com.fragnostic"        % "fragnostic-conf-props_2.13"          % "0.1.7"
