...
object Dependencies {
  ...
  lazy val fragnosticConfCache     = "com.fragnostic"        % "fragnostic-conf-cache_2.13"          % "0.2.9"
  lazy val fragnosticConfEnv       = "com.fragnostic"        %  "fragnostic-conf-env_2.13"           % "0.1.11"
  lazy val fragnosticConfProps     = "com.fragnostic"        % "fragnostic-conf-props_2.13"          % "0.1.9"
